...
- **Paleta de colores y variables CSS:**
  - `--color-dark`: negro absoluto (`rgba(0, 0, 0, 1)`) — fondo principal.
  - `--color-white`: blanco puro (`rgba(255, 255, 255, 1)`) — texto y elementos destacados.
  - `--color-grey-dark`: gris oscuro (`rgba(68, 68, 68, 1)`) — bordes, separadores, detalles secundarios.
  - `--color-grey-light`: gris claro (`rgba(146, 144, 144, 1)`) — fondos de bloques, hover, detalles sutiles.
